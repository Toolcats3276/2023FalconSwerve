...
public class OnePieceAutoRed extends SequentialCommandGroup {
    public OnePieceAutoRed(Swerve s_Swerve){
...
//loads path
PathPlannerTrajectory first = PathPlanner.loadPath("onePieceRed", new PathConstraints(1.75, 0.6));
